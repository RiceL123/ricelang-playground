 ...
 * UnParser.java      
 *
 * This tool was developed for the primary purpose of automating the marking
 * process for Assignment 3. Additionally, it exemplifies the effectiveness 
 * of the visitor design pattern as a valuable object-oriented approach in 
 * the creation of contemporary software tools, including code generators. 
 * Furthermore, it highlights that a basic knowledge of compilation 
 * techniques can facilitate the development of utilities like pretty 
 * printers and language translators, particularly between languages 
 * with comparable programming paradigms. For instance, it is relatively 
 * simple to create a converter between C and languages with similar 
 * programming constructs, such as VC.
 *
 * --- Jingling
 */

package ricelang.VC.UnParser;
