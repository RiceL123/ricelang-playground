 ...
 *
 * Once the Unparser was written, this was written in a matter of hours.
 *
 * --- Jingling
 */

package ricelang.VC.TreePrinter;
...
public class Printer implements Visitor {
 ...
 // Lists
  ...
  public Object visitEmptyArrayExprList(EmptyArrayExprList ast, Object o) {
    print(indentString() + "EmptyArrExprList");
    return null;
  }
  ...
  public Object visitGlobalVarDecl(GlobalVarDecl ast, Object o) {
    print(indentString() + "GlobalVarDecl");
    ++indent;
    ast.T.visit(this, o);
    ast.I.visit(this, o);
  ...
  public Object visitArrayInitExpr(ArrayInitExpr ast, Object o) {
    print(indentString() + "ArrInitExpr");
    ++indent;
    ast.IL.visit(this, o);
    --indent;
    return null;
  ...
  public Object visitArrayExprList(ArrayExprList ast, Object o) {
    print(indentString() + "ArrExprList");
    ++indent;
    ast.E.visit(this, o);
    ast.EL.visit(this, o);
    --indent;
