...
import ricelang.VC.StdEnvironment;
...
public final class Emitter implements Visitor {
    ...
    public Emitter(String inputFilename) {
        classname = inputFilename;
    }

    public final String genString(AST ast) {
        JVM.clearInstructions();
        ast.visit(this, null);
        return JVM.dump();
    }
     ...
     * to handle all array-related declarations and initialisations.
        ...
        emit(JVM.STATIC_FIELD, "scanner", "Ljava/util/Scanner;");
        ...
        emit(JVM.NEW, "java/util/Scanner");
        emit(JVM.DUP);
        emit(JVM.GETSTATIC, "java/lang/System/in Ljava/io/InputStream;");
        frame.push(3);
        emit(JVM.INVOKESPECIAL, "java/util/Scanner/<init>(Ljava/io/InputStream;)V");
        emit(JVM.PUTSTATIC, classname + "/scanner", "Ljava/util/Scanner;");
        frame.pop(3);
    ...
    public Object visitCallExpr(CallExpr ast, Object o) {
        ...
        switch (fname) {
            case "getInt" -> {
                ast.AL.visit(this, o);
                emit(JVM.GETSTATIC, classname + "/scanner", "Ljava/util/Scanner;");
                emit(JVM.INVOKEVIRTUAL, "java/util/Scanner/nextLine()Ljava/lang/String;");
                frame.push(2);
                emit(JVM.INVOKESTATIC, "java/lang/Integer/parseInt(Ljava/lang/String;)I");
                frame.pop();
            }
            case "putInt" -> {
                ...
                frame.push();
                ast.AL.visit(this, o);
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/print(I)V");
                frame.pop(2);
            }
            case "putIntLn" -> {
                emit(JVM.GETSTATIC, "java/lang/System/out Ljava/io/PrintStream;");
                frame.push();
                ast.AL.visit(this, o);
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/println(I)V");
                frame.pop(2);
            }
            case "getFloat" -> {
                ast.AL.visit(this, o);
                ...
                emit(JVM.INVOKEVIRTUAL, "java/util/Scanner/nextLine()Ljava/lang/String;");
                frame.push(2);
                emit(JVM.INVOKESTATIC, "java/lang/Float/parseFloat(Ljava/lang/String;)F");
                frame.pop();
            }
            case "putFloat" -> {
                emit(JVM.GETSTATIC, "java/lang/System/out Ljava/io/PrintStream;");
                frame.push();
                ast.AL.visit(this, o);
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/print(F)V");
                frame.pop(2);
            }
            case "putFloatLn" -> {
                emit(JVM.GETSTATIC, "java/lang/System/out Ljava/io/PrintStream;");
                frame.push();
                ast.AL.visit(this, o);
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/println(F)V");
                frame.pop(2);
            }
            case "putBool" -> {
                emit(JVM.GETSTATIC, "java/lang/System/out Ljava/io/PrintStream;");
                frame.push();
                ast.AL.visit(this, o);
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/print(Z)V");
                frame.pop(2);
            }
            case "putBoolLn" -> {
                emit(JVM.GETSTATIC, "java/lang/System/out Ljava/io/PrintStream;");
                frame.push();
                ast.AL.visit(this, o);
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/println(Z)V");
                frame.pop(2);
            }
            case "putString" -> {
                emit(JVM.GETSTATIC, "java/lang/System/out Ljava/io/PrintStream;");
            ...
            case "putStringLn" -> {
                ...
                frame.push();
                ast.AL.visit(this, o); // ldc the string
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/println(Ljava/lang/String;)V");
                frame.pop(2);
            }
            case "putLn" -> {
                emit(JVM.GETSTATIC, "java/lang/System/out Ljava/io/PrintStream;");
                frame.push();
                emit(JVM.INVOKEVIRTUAL, "java/io/PrintStream/println()V");
                frame.pop();
            }
            default -> {
