...
TeaVM.wasmGC =
  ...
  (() => {
    ...
    function i(o, l) {
      let u = Symbol("javaObject");
      let i = Symbol("functions");
      ...
      o.teavmJso = {
        ...
        createClass(e, t, n) {
          ...
          if (t === null) {
            ...
            o.prototype.constructor = t;
          }
          let o = A(e, function (e, t) {
            if (e === s) {
              r.call(this, t);
            } else if (n === null) {
          ...
          o.prototype = Object.create(t || Object.prototype);
          o.prototype.constructor = o;
          let a = A(e, function (e) {
    ...
    async function d(t, a) {
      let r = [];
      let l = {};
      for (let { module: o, name: e, kind: n } of WebAssembly.Module.imports(
        t,
      )) {
        if (n !== "global" || o in a) {
          continue;
    ...
    async function s(e, t) {
      ...
      let [o, a, l] = await Promise.all([
        n.enabled ? y(e, n) : Promise.resolve(null),
      ...
      let c = await WebAssembly.instantiate(a, u);
      s.supplyExports(c.exports);
      if (o) {
        let e = r === "auto" || r === "embedded" ? a : null;
        let t = h(e, l, o);
        if (t !== null) {
          s.supplyStackDeobfuscator(t);
        }
      }
      let f = { exports: i, instance: c, module: c.module };
      for (let t in c.exports) {
        let e = c.exports[t];
        if (e instanceof WebAssembly.Global) {
          Object.defineProperty(i, t, { get: () => e.value });
        }
      }
      return f;
    }
    ...
    function W() {
      if (c === null) {
        let e = new Int8Array([
          0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 2, 23, 1, 14, 119, 97,
          115, 109, 58, 106, 115, 45, 115, 116, 114, 105, 110, 103, 4, 99, 97,
          115, 116, 0, 0, 3, 1, 0, 5, 4, 1, 1, 0, 0, 10, -127, -128, -128, 0, 0,
        ]);
    ...
    async function y(e, t) {
      try {
        ...
        const { instance: a } = await WebAssembly.instantiateStreaming(
          fetch(o),
          n,
          { builtins: ["js-string"] },
        );
    ...
    return { load: s, defaults: p, wrapImport: t };
  })();
